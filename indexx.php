...
<div class="row">
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-body-secondary">Evaluación docente</h6>
    <p class="card-text">Agregar, modificar, o eliminiar las evaluaciones docentes.</p>
    <a href="#" class="card-link">Card link</a>
    <a href="#" class="card-link">Another link</a>
  </div>
  
</div>
<div class="card mf-auto" style="width: 16rem;">
