...
class NbTestAdapter {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.currentRun) {
                ...
                if (request.include) {
                    ...
                    for (let item of include) {
                        if (item.uri) {
                            ...
                            if (!cancellation.isCancellationRequested) {
                                yield vscode_1.commands.executeCommand(((_a = request.profile) === null || _a === void 0 ? void 0 : _a.kind) === vscode_1.TestRunProfileKind.Debug ? commands_1.extCommands.debugSingle : commands_1.extCommands.runSingle, item.uri.toString(), idx < 0 ? undefined : item.id.slice(idx + 1));
                            }
                        }
                    }
                }
                    ...
                    for (let workspaceFolder of vscode_1.workspace.workspaceFolders || []) {
                        if (!cancellation.isCancellationRequested) {
                            yield vscode_1.commands.executeCommand(((_b = request.profile) === null || _b === void 0 ? void 0 : _b.kind) === vscode_1.TestRunProfileKind.Debug ? commands_1.extCommands.debugTest : commands_1.extCommands.runTest, workspaceFolder.uri.toString());
                        }
                    }
                }
                if (this.started) {
    ...
    updateTests(suite, testExecution) {
        ...
        (_b = suite.tests) === null || _b === void 0 ? void 0 : _b.forEach(testCase => {
            ...
            const testUri = testCase.file ? vscode_1.Uri.parse(testCase.file) : undefined;
            if (currentTest) {
