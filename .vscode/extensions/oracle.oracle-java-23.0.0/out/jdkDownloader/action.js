...
class JdkDownloaderAction {
    constructor(logger, downloaderView) {
        this.logger = logger;
        ...
        this.startInstallation = () => __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.installType === JdkDownloaderAction.MANUAL_INSTALLATION_TYPE) {
                    vscode_1.workspace.getConfiguration('jdk').update('jdkhome', this.installationPath, true);
        ...
        this.generateDownloadUrl = () => {
            ...
            if (this.jdkType === view_1.JdkDownloaderView.OPEN_JDK_LABEL) {
                baseDownloadUrl = `${constants_1.OPEN_JDK_VERSION_DOWNLOAD_LINKS[`${this.jdkVersion}`]}_${this.osType.toLowerCase()}-${this.machineArch}_bin`;
            }
            else if (this.jdkType === view_1.JdkDownloaderView.ORACLE_JDK_LABEL) {
                baseDownloadUrl = `${constants_1.ORACLE_JDK_BASE_DOWNLOAD_URL}/${this.jdkVersion}/latest/jdk-${this.jdkVersion}_${this.osType.toLowerCase()}-${this.machineArch}_bin`;
            }
        ...
        this.extractJDK = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger.appendLine(`Error while extracting JDK: ${err.message}`);
        ...
        this.copyJdkAndFinishInstallation = () => __awaiter(this, void 0, void 0, function* () {
            ...
            vscode_1.workspace.getConfiguration('jdk').update('jdkhome', binPath, true);
