...
![Project Explorer](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/project-explorer.png)
...
![Debug configurations](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/debuggers.png)
...
* __Attach to Port__ & __Attach to Process__ - Attach debugger actions. Available when __Java+ ...__ at the bottom of drop down list is selected.
    * Select this configuration, then click the ![Run](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/run.png) 
...
![Run Configuration](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/run_config.png) 
...
![JDK Downloader](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/jdk_downloader.png) 
## Enabling Java Preview Features 
When using preview features use the quick fix action option to easily enable them.

![Enable Preview](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/enable_preview.gif)
...
![Class Source Actions](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Source_actions.png) 

### Introduce refactorings available via Show Code actions light bulb
![Introduce ... refactoring](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Introduce_refactoring.png)

### More Refactorings available also using Refactor... context menu
![More Refactorings](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Refactor_menu.png)

### Surround with refactorings
![Surrond with Refactorings](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Surrond_With_refactorings.png)
...
![Override refactoring](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Override_refactoring.png)
...
![Change method parameters refactoring](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/change_method_params.png)

### Move Members Refactoring
Move members refactoring provides dedicated form as well.
![Move members refactoring](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/move_refactoring.png)
...
![JavaDoc Completion](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/javadoc.png)
...
![Test Explorer](https://github.com/oracle/javavscode/raw/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/images/Test_explorer.png)
...
This project welcomes contributions from the community. Before submitting a pull request, please [review our contribution guide](https://github.com/oracle/javavscode/blob/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/../CONTRIBUTING.md)


## Security

Please consult the [security guide](https://github.com/oracle/javavscode/blob/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/../SECURITY.md) for our responsible security vulnerability disclosure process

## License

Copyright (c) 2024 Oracle and/or its affiliates.

Oracle Java Platform Extension for Visual Studio Code is licensed under [Apache 2.0 License](https://github.com/oracle/javavscode/blob/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/../LICENSE.txt). 
The [THIRD_PARTY_LICENSES](https://github.com/oracle/javavscode/blob/423c4812e2541a0dff62bac2a18431e98a820ec2/vscode/../THIRD_PARTY_LICENSES.txt) file contains third party notices and licenses.
